...
export default class MediaSourceAudioPlayer {
    constructor() {
        this.TAG = "[MediaSourceAudioPlayer]";
        this.mediaSource = null;
        this.audioElement = null;
        this.sourceBuffer = null;
        this.isInitialized = false;
        this.isPlaying = false; // 公开访问，用于外部检查播放状态
        this.volume = 1.0;
        this.MIME_TYPE = 'audio/webm;codecs=opus';
        this.queue = [];
        this.isUpdating = false;
        this.currentObjectURL = null;
        this.currentSpeechId = -1; // 当前播放的 speech_id
        this.firstFrameIndex = -1; // 第一个音频段的帧索引
        this.pendingStartFrameIndex = -1; // 等待开始播放的帧索引
