...
export class GLPipeline {
    ...
    constructor(device) {
        ...
        this.backgroundTextureSrc = null;
        this.meshPipelineInfo = null;
        this.maskPipelineInfo = null;
        this.meshInfos = [];
        this.meshStatistics = {
            max_pca_component_count: 4,
            max_bs_count: 4,
        ...
        this.initSkeletonStatus = [];
        this.frameDataCallback = () => null;
        this.currentGamma = { r: 1.0, g: 1.0, b: 1.0 };
        this.currentColorBalance = { rc: 0.0, gm: 0.0, by: 0.0 };
    ...
    _onRender() {
        ...
        if (null !== frameData) {
            ...
            if (!this.first_webgl_render) {
                window.performanceTracker.markEnd(performanceConstant.first_webgl_render);
