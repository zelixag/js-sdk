...
if (isMiniProgram()) {
  ...
  if (typeof globalThis !== 'undefined') {
    ...
    if ((globalThis as any).window) {
      (globalThis as any).window.Image = globalThis.Image;
    }
  }
  ...
  if (originalDocument && typeof originalDocument.createElement === 'function') {
    ...
    originalDocument.createElement = function(tagName: string, options?: any) {
  ...
  if (typeof globalThis !== 'undefined') {
    (globalThis as any).__socketIOAdapter = socketIOAdapter;
  }
}
