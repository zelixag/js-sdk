...
const pluginJson = {
  "publicComponents": {
    "plugin-avatar": "components/avatar"
  },
  "pages": [],
  "main": "index.js"
};
...
const pluginComponentDir = path.join(pluginSrcDir, 'components', 'avatar');
fs.mkdirSync(pluginComponentDir, { recursive: true });

// 注意：微信小程序插件组件需要放在独立目录下
// 目录结构：components/avatar/avatar.js
// plugin.json 配置：{ "avatar": "components/avatar" }
...
// 微信小程序插件组件需要 index.js 作为入口文件
fs.writeFileSync(path.join(pluginComponentDir, 'index.js'), avatarComponentJs);
